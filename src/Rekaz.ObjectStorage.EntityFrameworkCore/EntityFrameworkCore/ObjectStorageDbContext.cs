...
using Rekaz.ObjectStorage.ObjectFiles;
...
public class ObjectStorageDbContext :
    AbpDbContext<ObjectStorageDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ObjectFile>(b =>
        {
            b.ToTable(ObjectStorageConsts.DbTablePrefix + "ObjectFiles", ObjectStorageConsts.DbSchema);
